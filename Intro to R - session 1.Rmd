...
Finally, the last day of the course, we will use real reef fish data (or nutrient supply) and explore how important it is to consider the human dimensions for coral reef management (and explore how important fish is for the nutrient supply of different countries)
...
rm(x)
#Show x is no longer in the environment
x
```
