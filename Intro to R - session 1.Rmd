...
The third day we will introduce you to biodiversity metrics, and with R, we will calculate and compare different metrics. 

The fourth day, using real catch statistics from Madagascar, we will calculate catch statistics and visualize catch data in different ways.

Finally, the last day of the course, we will use real reef fish data and explore how important it is to consider the human dimensions for coral reef management. 
