...
Finally, the last day of the course, we will use real household surveys from X to .....(Jessica to fill in)
...
R is an open-source project, and available for free download via the web. 
...
To download RStudio, go to https://www.rstudio.com/products/rstudio/download/. Click the download button under the RStudio Desktop Open Source License (Free). Then, under "All installers", choose the link that matches your computer (e.g., Windows or Mac). RStudio will download to your computer. Open it and go through the installation process (.exe file for Windows). 

Congratulations! You know have R and RStudio downloaded on your computer. Now, we can start programming and modelling
